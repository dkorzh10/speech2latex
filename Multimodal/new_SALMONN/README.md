...
CUDA_VISIBLE_DEVICES=0,1,2,4,5,7 ./.venv/bin/torchrun --nproc_per_node=6 --master_port=29700 train.py --cfg-path configs/config.yaml

CUDA_VISIBLE_DEVICES=3 uv run inference.py --cfg-path="/home/jovyan/korzh/speech2latex/Multimodal/new_SALMONN/configs/decode_config.yaml" --device=cuda --test-table-path="/mnt/shared_ru.ml.SZ-2_000049/antispoofing_datasets/S2L_full_dataset/equations_test.csv" --metrics-path="/home/jovyan/korzh/speech2latex/Multimodal/new_SALMONN/metrics/eq_and_sent_train_full_to_s2l_eq_full_test.xlsx"
```

```shell
CUDA_VISIBLE_DEVICES=3 uv run inference.py \
  --cfg-path="/home/jovyan/korzh/speech2latex/Multimodal/new_SALMONN/configs/decode_config.yaml" \
  --device=cuda \
  --test-table-path="/mnt/shared_ru.ml.SZ-2_000049/antispoofing_datasets/S2L_full_dataset/equations_test.csv" \
  --metrics-path="/home/jovyan/korzh/speech2latex/Multimodal/new_SALMONN/metrics/eq_and_sent_train_full_to_s2l_eq_full_test.xlsx"
```
